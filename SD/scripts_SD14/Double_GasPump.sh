...
CUDA_VISIBLE_DEVICES=0 python generate_erased_small_imagenet.py \
    --erased_model models/UCE_double_proxy_GasPump/diffusion_pytorch_model.safetensors \
    --output_dir generated_Double_GasPump \
    --num_variations 10
...
CUDA_VISIBLE_DEVICES=0 python compare_accuracy.py \
    ...
    --erased_path generated_Double_GasPump \
    --concept 'gas pump' \
    --prompts_csv 'data/small_imagenet_prompts.csv' \
    --output_log 'DoubleResult_GasPump.log'
